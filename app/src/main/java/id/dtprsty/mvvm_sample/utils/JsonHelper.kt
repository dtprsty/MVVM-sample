package id.dtprsty.mvvm_sample.utils

import android.content.Context
import id.dtprsty.mvvm_sample.data.source.remote.response.ContentResponse
import id.dtprsty.mvvm_sample.data.source.remote.response.CourseResponse
import id.dtprsty.mvvm_sample.data.source.remote.response.ModuleResponse
...
class JsonHelper(private val context: Context) {
    ...
    fun loadCourses(): MutableList<CourseResponse> {
        val list: MutableList<CourseResponse> = mutableListOf()
        try {
            val responseObj = JSONObject(parsingFileToString("CourseResponses.json").toString())
            val listArray = responseObj.getJSONArray("courses")
